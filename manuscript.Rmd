...
```{r 01_bad_dates, fig.cap="A spreadsheet with inconsistent date formats."}
...
```{r 02_blank_cells, fig.width=12, fig.cap="Examples of spreadsheets with blank cells. **A:** A spreadsheet where only the first of several repeated values was included. **B:** A spreadsheet with a complicated layout and some implicit column headers."}
...
```{r 04_example_rectangle, fig.height=3, fig.cap="An example spreadsheet with a rectangular layout."}
set.seed(20150803)
...
```{r 05_non_rectangular, fig.height=8, fig.width=12, fig.cap="Examples of spreadsheets with non-rectangular layouts."}
...
```{r 07_two_header_rows, fig.width=10, fig.cap="A spreadsheet with two header rows."}
